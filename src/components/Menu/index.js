...
export const Menu = () => {
    ...
    menuSection.innerHTML = `
      <div class="container">
        <h2>Naše nabídka</h2>
        <p class="menu-intro">Vyberte si z našeho interaktivního menu a nemusíte čekat na obsluhu</p>
          ...
          <div class="drink">
            <div class="drink__product">
              ...
              <div class="drink__info">
                <h3>Espresso</h3>
                <div class="layer">
                  <div class="layer__color" style="background-color: #613916
  "></div>
          ...
          <div class="drink">
            <div class="drink__product">
              ...
              <div class="drink__info">
                <h3>Lungo</h3>
                <div class="layer">
                  <div class="layer__color" style="background-color: #B0DEE1
  "></div>
